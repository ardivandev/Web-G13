...
<div class="card shadow mb-4 bg-white">
    <div class="card-body">
        <form method="POST" action="{{ route('petugas.barang.update', $barang->id_barang) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
...
{{-- Gambar lama --}}
            ...
            <button type="submit" class="btn btn-success">Simpan Perubahan</button>
             <a href="{{ route('petugas.barang.index') }}" class="btn btn-primary">Kembali</a>
        </form>
    </div>
</div>
@endsection
