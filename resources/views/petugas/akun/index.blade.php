...
<div class="row">
    <div class="col-md-12">
        <h1 class="h3 mb-4 text-gray-800">Profil Petugas</h1>
    ...
    <div class="card p-4">
        <form method="POST" action="{{ route('petugas.akun.updatePassword') }}">
            @csrf
            @method('PUT')

            <div class="mb-3">
                <label>Nama</label>
                <input type="text" class="form-control" value="{{ $user->nama_petugas }}" readonly>
            </div>
