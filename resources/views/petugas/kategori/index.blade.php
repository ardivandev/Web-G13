...
<div class="card shadow mb-4 bg-white">
    <div class="card-body">
        <a href="{{ route('petugas.kategori.create') }}" class="btn btn-primary mb-3">Tambah Kategori</a>

        <div class="card shadow mb-4 bg-white px-3">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                <form action="{{ route('petugas.kategori.index') }}" method="GET" class="form-inline">
                ...
                <table class="table table-bordered table-sm" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('petugas.kategori.edit', ['kategori' => $k->id_kategori]) }}" class="btn btn-sm btn-warning">Edit</a>
                                <form action="{{ route('petugas.kategori.destroy', ['kategori' => $k->id_kategori]) }}" method="POST" class="d-inline">
