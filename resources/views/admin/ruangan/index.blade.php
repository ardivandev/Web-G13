...
<h1 class="h3 mb-4 text-gray-800">Data Ruangan</h1>
    ...
    <div class="card-body">
        ...
        <div class="card shadow mb-4 bg-white px-3">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                <form action="{{ route('admin.ruangan.index') }}" method="GET" class="form-inline">
                    <input type="text" name="search" value="{{ request('search') }}" class="form-control form-control-sm mr-2" placeholder="Cari ruangan">
                ...
                <table class="table table-bordered table-sm" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.ruangan.edit', $r->id_ruangan) }}" class="btn btn-sm btn-warning">Edit</a>
